...
func Prepare(ctx context.Context, db DBTX) (*Queries, error) {
	...
	if q.getAccountGraphStmt, err = db.PrepareContext(ctx, getAccountGraph); err != nil {
		return nil, fmt.Errorf("error preparing query GetAccountGraph: %w", err)
	}
...
func (q *Queries) Close() error {
	...
	if q.getAccountGraphStmt != nil {
		if cerr := q.getAccountGraphStmt.Close(); cerr != nil {
			err = fmt.Errorf("error closing getAccountGraphStmt: %w", cerr)
		}
	}
...
func (q *Queries) WithTx(tx *sql.Tx) *Queries {
	return &Queries{
		...
		getAccountGraphStmt: q.getAccountGraphStmt,
